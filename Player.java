...
public class Player {
	...
	public Player() {
		...
		this.positionY=0;
		this.notes=0;
		this.facing=3;	//1-északranéz, 2-keletre, 3-délre, 4-nyugatra
		ImageIcon imgDown = new ImageIcon(".\\characterDown.jpg"); // kép olvasás
		down = imgDown.getImage(); //kép tárolás
	...
	public void move(char arrow, boolean fieldBlock){ //fields[positionX][PositionY].isBlockot vár
		if(arrow=='w') {
	...
	//GET/SETTEREK
	public Image getPlayerImage() {	// kép lekérdezése memóriából
		if(this.facing==1) {
			return this.up;
		}
		if(this.facing==2) {
