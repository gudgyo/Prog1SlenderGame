...
public class Generators {
	...
	Random rand = new Random();			//random szamot ad ket ertek kozott
	...
	public void generateThings() {		//palyan levo targyakat generala fuggvenyeket inditja..
		this.generateFields();
		this.generateHouse();
		this.generateRock();
		this.generateRock();
	...
	public void setVisibility(int playerPositionX, int playerPositionY) {//a karakter 4 mezo tavolsagra lat
		for(int a=0;a<15;a++) {
			for(int b=0;b<15;b++) {
